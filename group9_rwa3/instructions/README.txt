...
4) Move the my_map.pgm and my_map.yaml files to the 'maps' folder in the 'mapping' package
5) Before starting location recording read the new_room_breakdown file in the 'instructions' folder
